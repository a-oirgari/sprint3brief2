...
<div class="flex min-h-screen">
    ...
    <aside class="w-64 bg-cyan-600 text-white p-6">
        ...
        <nav class="space-y-4">
            <a href="dashboard.php" class="block font-semibold hover:text-gray-200">Dashboard</a>
            <a href="patients/index.php" class="block hover:text-gray-200">Patients</a>
