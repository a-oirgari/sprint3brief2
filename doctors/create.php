...
<div class="flex items-center flex-col justify-center">
    ...
    <form method="POST" class="bg-white p-6 rounded-2xl shadow max-w-md py-12 space-y-4">
        ...
        <input name="first_name" placeholder="First name" class="w-full border p-2" required>
        <input name="last_name" placeholder="Last name" class="w-full border p-2" required>
        <input name="specialization" placeholder="Specialization" class="w-full border p-2" required>
