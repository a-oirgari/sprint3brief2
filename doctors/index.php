...
<div class="flex min-h-screen">
    ...
    <aside class="w-64 bg-cyan-600 text-white p-6">
        ...
        <nav class="space-y-4">
            ...
            <a href="../patients/index.php" class="block font-semibold hover:text-gray-200"><i class="fa-solid fa-user-injured"></i> Patients</a>
            <a href="index.php" class="block hover:text-gray-200"><i class="fa-solid fa-user-doctor"></i> Doctors</a>
        ...
        <div class="bg-white mt-6 rounded shadow overflow-hidden">
            <table class="w-full text-left border-collapse">
                ...
                <tbody>
                    ...
                    <tr class="border-t">
                        <td class="p-2"><?= htmlspecialchars($doctor['first_name'] ." ".$doctor['last_name']) ?></td>
                        <td><?= $doctor['specialization'] ?></td>
                        <td><?= $doctor['department_name'] ?></td>
                        <td class="p-3 flex justify-evenly">
                            <a href="edit.php?id=<?= $doctor['doctor_id'] ?>" class="text-blue-600">
                            ...
                            <a href="delete.php?id=<?= $doctor['doctor_id'] ?>" class="text-red-600"
